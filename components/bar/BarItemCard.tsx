...
import { useUpdateBarItem, type BarItem } from "@/components/bar/useBarQueue";
      ...
      <CardContent className="space-y-4 pt-6">
          ...
          {item.status === "pending" ? (
            <>
              <Button
                type="button"
                size="sm"
                disabled={updateBarItem.isPending}
                onClick={() =>
        ...
        {updateBarItem.error ? (
          <p className="text-sm text-destructive">
            {updateBarItem.error instanceof Error
              ? updateBarItem.error.message
